...
## Project Overview
Vite + React + TypeScript real estate agent website (Engel & Völkers / Catherine Redmond). Single-page app with client-side routing (custom hash-free router in `src/lib/router.ts`).
